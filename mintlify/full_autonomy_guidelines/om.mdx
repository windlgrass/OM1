...
Full autonomy is currently supported for Unitree Go2 and G1.

Note : Run OM1 via `uv run src/run.py config` for development purposes and keep the Docker container disabled.
