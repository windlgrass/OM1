...
Before building with OM1, make sure you've completed the [Getting Started](../developing/1_get-started.mdx) guide and have OM1 installed. Understand the important concepts and components that are part of OM1.
