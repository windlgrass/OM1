---
title: OM1 ROS2 SDK
description: "OM1 ROS2 SDK"
---

This provides the full ROS2 system for running the Unitree Go2, G1 and the Limx Tron SDK.
...
```
2. Open a terminal in the `OM1-ros2-sdk` directory.
...
- [Limx Tron Documentation](https://www.limxdynamics.com/en/tron1)
